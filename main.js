...
var StopwatchLap = /** @class */ (function () {
    ...
    StopwatchLap.prototype.addComment = function (comment) {
...
var Stopwatch = /** @class */ (function () {
    ...
    Stopwatch.prototype.continiueLap = function (id) {
        this.stop();
        if (this.lapsMap[id])
            this.activeLap = this.lapsMap[id].start();
        return this;
    };
...
module.exports = ".stopwatch-lap {\n  margin: 10px 0;\n  padding: 0; }\n  .stopwatch-lap-time {\n    flex: 0; }\n  .stopwatch-lap-comment {\n    white-space: nowrap;\n    text-overflow: ellipsis;\n    overflow: hidden;\n    display: block; }\n  .stopwatch-lap-content {\n    display: flex;\n    flex-direction: row;\n    justify-content: space-between;\n    align-items: center; }\n  .stopwatch-lap-actions {\n    padding: 0; }\n  .stopwatch-lap-comment-input {\n    width: 100%; }\n  .stopwatch-hint {\n  text-align: center;\n  display: block;\n  margin: 15px 0;\n  color: #808080; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
